// Solution reads the problem as an adjacency matrix, then uses Dijkstra with
// dynamic programming. The lookup table stores for a given node and number of
// used police stations the best probability seen so far.
// 
// graph:    double[][] as adjacency matrix, -1 means unconnected
//           value as edge-weight (here: chance between 0 and 1)
// dijkstra: create a Node object with curr pathlength for each potential node
...
public class ProblemA_dkp2005
{

	public static void main(String[] args) throws Throwable
	{
		new ProblemA_dkp2005();
	}
	
	public ProblemA_dkp2005() throws Throwable
	{
